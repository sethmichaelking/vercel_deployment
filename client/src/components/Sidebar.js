...
function Left() {
  return (
    <div class='@container'>
                <aside
                    className="fixed top-0 left-0 z-40 w-58 h-screen pt-14 transition-transform -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
                    aria-label="Sidenav"
                        ...
                        <ul className="space-y-2">
                            <li>
                                ...
                                >
                                    ...
                                    <span className="ml-3">My Scans</span>
                                </a>
                            </li>
